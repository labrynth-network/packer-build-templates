## Ubuntu Server Noble (24.04.x) Template - Large
################################################################################### 
...
###########################################
source "proxmox-iso" "ubuntu-noble-large" {
    ...
    vm_id                = "804"
    vm_name              = "ubuntu-noble-large"
    template_description = "Ubuntu Server (Noble 24.04.x) Template - Large"
...
build {
    ...
    name    = "ubuntu-noble-large"
    sources = ["source.proxmox-iso.ubuntu-noble-large"]
